...
local gangs have been blocked off in sector 6. Fighting over the stolen
...
their way, and they aren't afraid to put up a fight.
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.8\linewidth]{powerups_unknown.png}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.8\linewidth]{powerups_known.png}
