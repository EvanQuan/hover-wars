...
public:
    ...
    Mesh* generateBillboardMesh(vec3 vPosition, vec3 vNormal, vec2 vUVStart, vec2 vUVEnd, float fHeight, float fWidth, const Material* pMaterial, const void* pOwnerHandle );
