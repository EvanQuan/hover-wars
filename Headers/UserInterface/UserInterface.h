...
#define IMAGE_BACKGROUND_MAIN_MENU "textures/menu/main_menu4.jpg"
...
#define IMAGE_BACKGROUND_POST_MENU "textures/menu/post_menu2.jpg" 
#define IMAGE_BACKGROUND_PRE_MENU "textures/menu/pre_menu.jpg" 
