...
public:
    ...
    void createRocketObjects(const char* cName, const mat4* m4Transform, const vec3 *vVelocity, float fBBLength, PxRigidDynamic** pReturnBody, PxShape** pReturnShape);
    void createFlameObject(const char* cName, const vec3* vPosition, float fHeight, float fRadius, PxRigidDynamic** pReturnBody, PxShape** pReturnShape);
    void removeRigidDynamicObj(PxRigidDynamic* pActor, PxShape* pShape);
