...
const vec3 COLORS[MAX_HOVERCRAFT_COUNT]{
    vec3(0.0f, 0.0f, 2.55f),    /*PLAYER 1*/
    vec3(0.0f, 2.55f, 0.0f),    /*PLAYER 2*/
    vec3(2.55f, 0.0f, 0.0f),    /*PLAYER 3*/
    vec3(2.55f, 0.0f, 2.55f),   /*PLAYER 4*/
    vec3(0.0f, 2.55f, 2.55f),   /*BOT 1*/
    vec3(2.55f, 2.55f, 0.0f),   /*BOT 2*/
    vec3(0.5f),                 /*BOT 3*/
    vec3(2.55f)                 /*BOT 4*/
};
