                              ...
                              vector<pair<float, float>> componentTranslating)
{
    ...
    m_Textures[IMAGE_5_1] = TEXTURE_MANAGER->loadTexture(IMAGE_5_1);
    m_Textures[IMAGE_6_1] = TEXTURE_MANAGER->loadTexture(IMAGE_6_1);
    m_Textures[IMAGE_7_1] = TEXTURE_MANAGER->loadTexture(IMAGE_7_1);
    m_Textures[IMAGE_8_1] = TEXTURE_MANAGER->loadTexture(IMAGE_8_1);
    m_Textures[IMAGE_9_1] = TEXTURE_MANAGER->loadTexture(IMAGE_9_1);
    m_Textures[IMAGE_10_1] = TEXTURE_MANAGER->loadTexture(IMAGE_10_1);
    m_Textures[IMAGE_0_2] = TEXTURE_MANAGER->loadTexture(IMAGE_0_2);
    ...
    m_Textures[IMAGE_5_2] = TEXTURE_MANAGER->loadTexture(IMAGE_5_2);
    m_Textures[IMAGE_6_2] = TEXTURE_MANAGER->loadTexture(IMAGE_6_2);
    m_Textures[IMAGE_7_2] = TEXTURE_MANAGER->loadTexture(IMAGE_7_2);
    m_Textures[IMAGE_8_2] = TEXTURE_MANAGER->loadTexture(IMAGE_8_2);
    m_Textures[IMAGE_9_2] = TEXTURE_MANAGER->loadTexture(IMAGE_9_2);
    m_Textures[IMAGE_10_2] = TEXTURE_MANAGER->loadTexture(IMAGE_10_2);
